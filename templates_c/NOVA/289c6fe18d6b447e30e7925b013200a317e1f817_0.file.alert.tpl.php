...
/* Smarty version 4.5.4, created on 2025-02-11 12:39:31
  from '/www/htdocs/w01f28bd/waschi.sillytoots.de/includes/vendor/jtlshop/scc/src/scc/templates/alert.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.4',
  'unifunc' => 'content_67ab36f34f2962_57640733',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '289c6fe18d6b447e30e7925b013200a317e1f817' => 
    array (
      0 => '/www/htdocs/w01f28bd/waschi.sillytoots.de/includes/vendor/jtlshop/scc/src/scc/templates/alert.tpl',
      1 => 1739260988,
      2 => 'file',
    ),
  ),
...
function content_67ab36f34f2962_57640733 (Smarty_Internal_Template $_smarty_tpl) {
?><div role="alert"
    class="alert<?php if ($_smarty_tpl->tpl_vars['params']->value['class']->hasValue()) {?> <?php echo $_smarty_tpl->tpl_vars['params']->value['class']->getValue();
}?>
    <?php if ($_smarty_tpl->tpl_vars['params']->value['variant']->hasValue()) {?> alert-<?php echo $_smarty_tpl->tpl_vars['params']->value['variant']->getValue();
}?>
    <?php if ($_smarty_tpl->tpl_vars['params']->value['dismissible']->getValue() === true) {?> alert-dismissable<?php }?>
"
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
    <?php }?>>
<?php if ($_smarty_tpl->tpl_vars['params']->value['dismissible']->getValue() === true) {?>
    <button type="button" aria-label="<?php echo $_smarty_tpl->tpl_vars['params']->value['dismiss-label']->getValue();?>
" class="close" data-dismiss="alert">
        <span aria-hidden="true">&times;</span>
    </button>
<?php }?>
    <?php if ($_smarty_tpl->tpl_vars['params']->value['variant']->hasValue()) {?><div class="sr-only">x</div><?php }?>
