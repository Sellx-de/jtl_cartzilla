                    ...
                    {if !empty($title)}
                        {block name='snippets-product-slider-box-title'}
                            <div class="productlist-filter-headline">
                                {$title}
                                {if !empty($moreLink)}
                                    {link class="more float-right" href=$moreLink title=$moreTitle data-toggle="tooltip" data-bs-toggle="tooltip"
                        ...
                        {block name='snippets-product-slider-other-title'}
                            {if $titleContainer|default:false}<div class="container slick-slider-other-container">{/if}
                                <div class="d-flex flex-wrap justify-content-between align-items-center pt-1 border-bottom pb-4 mb-4">
                                    ...
                                    {if !empty($moreLink)}
                                        <div class="pt-3">
                                            <a class="btn btn-outline-accent btn-sm" href="{$moreLink}" title="{$moreTitle}">
