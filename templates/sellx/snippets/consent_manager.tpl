                                ...
                                <div class="consent-btn-helper">
                                    <div class="consent-accept">
                                        <button type="button" class="consent-btn consent-btn-outline-primary btn-block"
                                            ...
                                            {lang key='consentAll' section='consent'}
                                        </button>
                                    </div>
                                    <div>
                                        <button type="button" class="consent-btn consent-btn-outline-primary btn-block"
                                                id="consent-banner-btn-settings">
                                            {lang key='configure' section='consent'}
                                        </button>
                                    </div>
                                    <div>
                                        <button type="button"
                        ...
                        <div class="consent-btn-holder">
                            <div class="consent-switch">
                                <input type="checkbox" class="consent-input" id="consent-all-1" name="consent-all-1"
                                       data-toggle="consent-all" data-bs-toggle="consent-all">
                        ...
                        {foreach $consentItems as $item}
                            ...
                            <div class="consent-switch">
                                {block name='snippets-consent-manager-settings-items-checkbox'}
                                    <input type="checkbox" class="consent-input" id="consent-{$id}" name="consent-{$id}"
                                ...
                                {block name='snippets-consent-manager-settings-items-more-button'}
                                    {if $item->hasMoreInfo()}
                                        <a class="consent-show-more" href="#" data-collapse="consent-{$id}-description" data-bs-collapse="consent-{$id}-description">
                                    ...
                                    {if $item->hasMoreInfo()}
                                        <div class="consent-help consent-more-description consent-hidden"
                                            ...
                                            {if !empty({$item->getPrivacyPolicy()})}
                                                ...
                                                <a href="{$item->getPrivacyPolicy()}" target="_blank" rel="noopener">
