<div data-tnt-template=productdetails/pushed_success.tpl></div>{block name='productdetails-pushed-success'}
                    ...
                    {block name='productdetails-pushed-success-product-cell-links'}
                        {row class="pushed-success-buttons"}
                            {col cols=12 md=6}
                                ...
                                {/if}
                                {link href=$lastVisitedProductListURL|cat:'#buy_form_'|cat:$productID class="btn btn-outline-primary btn-block continue-shopping"
