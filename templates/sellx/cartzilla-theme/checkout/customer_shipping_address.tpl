                        ...
                        {formgroup
                            ...
                            {else}
                                {input
                                    ...
                                    id="{$prefix}-{$name}-state"
                                    data=[
                                        "toggle"=>"state","bs-toggle"=>"state",
                                        "defaultoption"=>{lang key=pleaseChoose},
                                        "target"=>"#{$prefix}-{$name}-country","bs-target"=>"#{$prefix}-{$name}-country"
                                    ]
                ...
                {block name='checkout-customer-shipping-address-zip'}
                    {formgroup
                        ...
                        {input
                            ...
                            placeholder=" "
                            data-toggle="postcode" data-bs-toggle="postcode"
                            data-city="#{$prefix}-{$name}-city" data-bs-city="#{$prefix}-{$name}-city"
                            data-country="#{$prefix}-{$name}-country" data-bs-country="#{$prefix}-{$name}-country"
