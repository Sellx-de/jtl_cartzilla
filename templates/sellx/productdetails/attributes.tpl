                                        ...
                                        {else}
                                            {block name='productdetails-attributes-image'}
                                                <a {if !$inQuickView}href="{$characteristicValue->getURL()}"{/if}
                                                    ...
                                                    data-toggle="tooltip" data-bs-toggle="tooltip" data-placement="top" data-bs-placement="top" data-boundary="window" data-bs-boundary="window"
                                                ...
                                                >
                                                    ...
                                                    {else}
                                                        {badge variant="primary" class="text-bg-primary"}{$characteristicValue->getValue()|escape:'html'}{/badge}
                                                    {/if}
                                                </a>
                                            {/block}
                                        {/if}
