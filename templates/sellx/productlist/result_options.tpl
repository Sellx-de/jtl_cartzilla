                ...
                {if $show_filters}
                    {block name='productlist-result-options-filter-link-filter'}
                        {button id="js-filters" variant="outline-secondary"
                            ...
                            data=["toggle" => "{if !empty($filterPlacement)}{$filterPlacement}{else}modal{/if}","bs-toggle" => "{if !empty($filterPlacement)}{$filterPlacement}{else}modal{/if}", "target" => "#collapseFilter","bs-target" => "#collapseFilter"]
                            aria=["expanded" => "false",
