...
class Minify_JS_ClosureCompiler
{
     ...
     */
    public const DEFAULT_MAX_BYTES = 1800000;
     ...
     */
    public static function minify($js, array $options = []): string
    {
     ...
     * @throws Minify_JS_ClosureCompiler_Exception
     */
    protected function getResponse(string $postBody): string
    {
        ...
        if ($contents === false) {
            throw new Minify_JS_ClosureCompiler_Exception('No HTTP response from server');
        }
     ...
     * @return string
     */
    protected function buildPostBody($js, bool $returnErrors = false): string
    {
