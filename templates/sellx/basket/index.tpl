                                        ...
                                        {if $KuponMoeglich == 1}
                                            {block name='basket-index-coupon-available'}
                                                ...
                                                {block name='basket-index-coupon-heading'}
                                                    <strong class="font-size-lg" data-toggle="collapse" data-bs-toggle="collapse" data-target="#coupon-form" data-bs-target="#coupon-form">{lang key='useCoupon' section='checkout'}</strong>
                                                {/block}
                                                {/cardheader}
