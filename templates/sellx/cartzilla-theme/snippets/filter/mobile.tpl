                                    ...
                                    <li class="snippets-filter-mobile-item">
                                        {block name='snippets-filter-mobile-filters-button'}
                                            {link class="collapsed"
                                                data=["toggle"=> "collapse","bs-toggle"=> "collapse", "target"=>"#filter-collapse-{$subFilter->getFrontendName()|seofy}","bs-target"=>"#filter-collapse-{$subFilter->getFrontendName()|seofy}"]
                                                rel="nofollow"}
                            ...
                            <li class="snippets-filter-mobile-item">
                                {if $filter->getClassName() === "JTL\Filter\Items\PriceRange"}
                                    {block name='snippets-filter-mobile-filters-price-range'}
                                        {link class="collapsed"
                                            data=["toggle"=> "collapse","bs-toggle"=> "collapse", "target"=>"#filter-collapse-{$filter->getFrontendName()|seofy}","bs-target"=>"#filter-collapse-{$filter->getFrontendName()|seofy}"]
                                            rel="nofollow"}
                                ...
                                {elseif $filter->getOptions()|count > 0}
                                    {block name='snippets-filter-mobile-filters-generic'}
                                        {link data=["toggle"=> "collapse","bs-toggle"=> "collapse", "target"=>"#filter-collapse-{$filter->getFrontendName()|seofy}","bs-target"=>"#filter-collapse-{$filter->getFrontendName()|seofy}"] rel="nofollow"}
                                            <span class="text-truncate">{$filter->getFrontendName()}</span>
                                        {/link}
                                        {collapse id="filter-collapse-{$filter->getFrontendName()|seofy}"
                                            class="snippets-filter-mobile-item-collapse"
            ...
            {formrow class="snippets-filter-mobile-buttons"}
                {col}
                    {button block=true
                        ...
                        class="no-caret"
                        data=['toggle'=>'collapse','bs-toggle'=>'collapse', 'dismiss'=>'modal']
                        href="#collapseFilter"
