                        ...
                        {foreach $rmaService->rmas as $rma}
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div id="rmaAdditional{$rma->id}" class="modal fade" data-backdrop="static" data-bs-backdrop="static" data-keyboard="false" data-bs-keyboard="false" tabindex="-1" aria-labelledby="rmaAdditional{$rma->id}Label" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered modal-lg">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    ...
                                                    <button type="button" class="close" data-dismiss="modal" data-bs-dismiss="modal" aria-label="{lang key='rmaClose' section='rma'}">
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal" data-bs-dismiss="modal">{lang key='rmaClose' section='rma'}</button>
                                ...
                                <td class="text-right">
                                    {buttongroup}
                                        <button type="button" class="btn btn-secondary btn-sm mr-2" data-toggle="modal" data-bs-toggle="modal" data-target="#rmaAdditional{$rma->id}" data-bs-target="#rmaAdditional{$rma->id}" title="{lang key='showItems' section='rma'}">
