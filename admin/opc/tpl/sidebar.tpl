    ...
    <div id="editorNavbar">
        ...
        <ul class="nav nav-tabs flex-nowrap" id="opcTabs">
            <li class="nav-item animate-underline">
                <a class="nav-link fs-xs fw-normal p-0 animate-target active" href="#portlets" data-toggle="tab">{__('Portlets')}</a>
            </li>
            <li class="nav-item animate-underline">
                <a class="nav-link fs-xs fw-normal p-0 animate-target" href="#blueprints" data-toggle="tab">{__('Blueprints')}</a>
            </li>
            <li class="nav-item animate-underline">
                <a class="nav-link fs-xs fw-normal p-0 animate-target" href="#revisions" data-toggle="tab">{__('Revisions')}</a>
            </li>
            <li class="nav-item animate-underline" id="btnPagetree">
                <a class="nav-link fs-xs fw-normal p-0 animate-target" href="#pagetree" data-toggle="tab">{__('Page structure')}</a>
            </li>
        </ul>
        <button class="nav-link fs-xs fw-normal p-0 animate-target d-none" id="navScrollRight"><i class="fas fa-angle-double-right"></i></button>
    </div>
